...

  {
    ...
    guide: {
      text:
        ...
        이미지와 이름, 그리고 원한다면 추가 프롬프트에 너가 원하는 캐릭터를 묘사해주고 캐릭터 생성 미리보기를 눌르기만 하면 너만의 캐릭터가 태어날거야.
        물론, 완전히 무료는 아니야. 한 번 캐릭터를 생성할때마다 부화권을 하나씩 소모해야해. 하루에 하나씩 무료 부화권이 지급되지만 부족하다면 **상점**에서 부화권을 구매해봐!`,
    },
  },
];
