    ...
    return (
        <div className="h-screen flex flex-col bg-gray-900 overflow-hidden">
            ...
            <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 flex-grow w-full">
                <div className="bg-gray-800 p-6 sm:p-10 rounded-xl shadow-2xl border border-gray-700">
                    ...
                    <div className="border-b border-gray-700 pb-4 mb-6">
                        ...
                        <div className="flex flex-wrap items-center text-sm text-gray-400 mt-2 space-x-4 sm:space-x-6">
                    ...
                    <div 
                        className="prose prose-invert max-w-none text-lg leading-relaxed whitespace-pre-wrap text-gray-200"
                    >
                ...
                <div className="flex justify-between items-center mt-8 pt-4 border-t border-gray-700">
                    ...
                    <button 
                        onClick={() => navigate('/notice')}
                        className="px-6 py-3 bg-gray-700 text-white font-bold rounded-lg hover:bg-gray-600 transition flex items-center"
                    >
                        <List className="w-5 h-5 mr-2" />
                        목록으로
                    </button>
