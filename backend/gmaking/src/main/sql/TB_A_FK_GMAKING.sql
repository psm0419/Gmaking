...
-- ====================================================================
-- TB_AI_USAGE_LOG.sql (AI 토큰 사용량 로그 테이블)
-- ====================================================================
...
-- ====================================================================
-- TB_BATTLE_ACTION.sql (턴별 전투 로그 테이블)
-- ====================================================================
...
(
    ...
    FOREIGN KEY (OPPONENT_ID) REFERENCES TB_USER (USER_ID)
) COMMENT='배틀 로그 정보';

-- ====================================================================
-- TB_CHARACTER.sql (캐릭터 기본 정보 테이블)
-- ====================================================================
...
-- ====================================================================
-- TB_CHARACTER_PERSONALITY.sql (캐릭터 성격 테이블)
-- ====================================================================
...
-- ====================================================================
-- TB_CHARACTER_STAT.sql
-- ====================================================================
-- TB_CHARACTER_STAT (캐릭터 테이블 - 스탯 정의)
CREATE TABLE TB_CHARACTER
(
    CHARACTER_ID      VARCHAR(50) NOT NULL PRIMARY KEY COMMENT '캐릭터 ID',
...
-- ====================================================================
-- TB_COMMUNITY_LIKE.sql (커뮤니티 좋아요 기록 테이블)
-- ====================================================================
...
-- ====================================================================
-- TB_COMMUNITY_POST.sql (커뮤니티 게시글 테이블)
-- ====================================================================
...
-- ====================================================================
-- TB_COMMUNITY_REPORT.sql (커뮤니티 신고 기록 테이블)
-- ====================================================================
...
-- ====================================================================
-- TB_DIALOGUE.sql (AI/ 캐릭터 대화 기록 테이블)
-- ====================================================================
...
-- ====================================================================
-- TB_IMAGE.sql (이미지 테이블. 테이블명은 TB_IMAGE)
-- ====================================================================
-- TB_IMAGE (이미지 테이블)
CREATE TABLE TB_IMAGE
(
    IMAGE_ID     INT(50) NOT NULL PRIMARY KEY COMMENT '이미지 ID',
    IMAGE_NAME   VARCHAR(100) NOT NULL COMMENT '이미지 주소', -- VARCHAR2를 MySQL 표준 VARCHAR로 수정
...
-- ====================================================================
-- TB_MINI_GAME_RESULT.sql (미니 게임 결과 테이블)
-- ====================================================================
...
-- ====================================================================
-- TB_USER_EMAIL_VERIFY.sql (이메일 인증 테이블)
-- ====================================================================
...
-- ====================================================================
-- TB_USER_PRODUCT.sql (유저 상품/재화 테이블)
-- ====================================================================
