...
(
    USAGE_LOG_ID   INT          NOT NULL PRIMARY KEY AUTO_INCREMENT COMMENT '로그 ID',
    USER_ID        VARCHAR(50)  NOT NULL COMMENT '사용자 ID',
    FEATURE_TYPE   VARCHAR(50)  NOT NULL COMMENT '기능 유형',
    MODEL_NAME     VARCHAR(100) NOT NULL COMMENT '모델명',
    INPUT_TOKEN    INT          NOT NULL DEFAULT 0 COMMENT '입력 토큰 수',
    OUTPUT_TOKEN   INT          NOT NULL DEFAULT 0 COMMENT '출력 토큰 수',
    TOTAL_COST     INT COMMENT '예상 비용',
    REQUEST_COUNT  INT COMMENT '요청 횟수',
...
(
    CONVERSATION_ID INT NOT NULL PRIMARY KEY AUTO_INCREMENT COMMENT '대화 ID',
    USER_ID         VARCHAR(50) NOT NULL COMMENT '사용자 ID',
    CHARACTER_ID    VARCHAR(50) NOT NULL COMMENT '캐릭터 ID',
...
(
    MESSAGE_ID      INT NOT NULL PRIMARY KEY AUTO_INCREMENT COMMENT '메시지 ID',
    CONVERSATION_ID INT NOT NULL COMMENT '대화 세션 ID',
    SENDER          ENUM('user', 'character') NOT NULL COMMENT '발신자 유형',
...
(
    PERSONA_ID INT NOT NULL PRIMARY KEY AUTO_INCREMENT COMMENT '페르소나 ID',
    CHARACTER_ID VARCHAR(50) NOT NULL COMMENT '캐릭터 ID',
    INSTRUCTION_PROMPT TEXT COMMENT 'AI 지시 프롬프트',
    CREATED_AT DATETIME COMMENT '생성 일시',
    UPDATED_AT DATETIME COMMENT '수정 일시'
) COMMENT='AI 캐릭터 페르소나/프롬프트 정보';
...
(
    ...
    CHARACTER_ID      VARCHAR(50)  NULL COMMENT '사용자 캐릭터 ID',
    CREATED_DATE      DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '생성 일자',
